...
/// <summary> Generic class Objs can take any data type and enumerate through it </summary>
class Objs<T> : IEnumerable<T>
{
    List<T> roomObjects = new List<T>();

    /// <summary> Add a new object to our list </summary>
    public void Add(T roomItem)
    {
        roomObjects.Add(roomItem);
    }

    /// <summary> Return the list of room objects </summary>
